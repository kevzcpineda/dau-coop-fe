...
import { Image, Box, Button, Grid, GridItem, Input, FormControl, FormLabel } from '@chakra-ui/react';
          ...
          <Grid templateColumns='repeat(3, 1fr)' my={4} gap={5}>
            <GridItem>
              <FormControl>
                ...
                <Input type="date" onChange={e => setDateOfMembership(e.target.value)} />
              </FormControl>
            </GridItem>
            <GridItem>
              <FormControl>
            ...
            <GridItem>
              <FormControl>
                ...
                <Input value={memberStatus} onChange={e => setMemberStatus(e.target.value)} />
              </FormControl>
            </GridItem>
          </Grid>
          <Grid templateColumns='repeat(3, 1fr)' my={4} gap={5}>
          ...
          <Grid templateColumns='repeat(3, 1fr)' my={4} gap={5}>
            <GridItem>
              <FormControl>
                ...
                <Input value={philhealthNumber} onChange={e => setPhilhealthNumber(e.target.value)} />
              </FormControl>
            </GridItem>
            <GridItem>
              <FormControl>
