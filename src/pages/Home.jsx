...
import { Image, Box, Grid, GridItem, Input, FormControl, FormLabel, Table,
    ...
    return (
      <Layout showHeader={false}>
        <Flex alignItems='center' justifyContent='center' height='100vh'>
          <Spinner thickness='10px' speed='0.65s' emptyColor='gray.200' color='blue.500' style={{ width: '150px', height: '150px' }} />
        </Flex>
      </Layout>
    );
  } else {
        ...
        <Box>
          <TableContainer>
            <Table variant='striped' colorScheme='gray'>
              ...
              <Tbody>
                {userInfo && userInfo.jeep_id?.map(jeep => (
                  <Tr key={jeep.id}>
                    <Td>{jeep.id}</Td>
